...
-- =============================================================================
INSERT INTO users (id, role_id, full_name, email, password, is_active, is_superuser, is_staff, created_at, updated_at) VALUES
-- Admin
(1, 1, 'Admin User', 'admin@lms.com', 'django_pbkdf2_placeholder_see_readme', TRUE, TRUE, TRUE, NOW(), NOW()),
-- Students
(2, 2, 'Sarah Johnson', 'sarah.johnson@example.com', 'django_pbkdf2_placeholder_see_readme', TRUE, FALSE, FALSE, NOW(), NOW()),
(3, 2, 'Michael Chen', 'michael.chen@example.com', 'django_pbkdf2_placeholder_see_readme', TRUE, FALSE, FALSE, NOW(), NOW()),
(4, 2, 'Priya Sharma', 'priya.sharma@example.com', 'django_pbkdf2_placeholder_see_readme', TRUE, FALSE, FALSE, NOW(), NOW()),
(5, 2, 'Luca Rossi', 'luca.rossi@example.com', 'django_pbkdf2_placeholder_see_readme', TRUE, FALSE, FALSE, NOW(), NOW()),
(6, 2, 'Amara Okafor', 'amara.okafor@example.com', 'django_pbkdf2_placeholder_see_readme', TRUE, FALSE, FALSE, NOW(), NOW());

-- =============================================================================
-- 3. courses  (created by admin user id=1)
-- =============================================================================
INSERT INTO courses (id, title, description, thumbnail, category, created_by, created_at, updated_at) VALUES
...
INSERT INTO lessons (id, course_id, title, content, video_url, order_no, created_at) VALUES
  (1,  1, 'HTML5 & Semantic Markup',
      ...
      'https://videos.mini-lms.dev/web-dev/lesson-01-html5.mp4', 1, NOW()),
  ...
  (2,  1, 'Modern CSS & Responsive Design',
      ...
      'https://videos.mini-lms.dev/web-dev/lesson-02-css3.mp4', 2, NOW()),
  ...
  (3,  1, 'JavaScript Fundamentals & ES2024',
      ...
      'https://videos.mini-lms.dev/web-dev/lesson-03-javascript.mp4', 3, NOW()),
  ...
  (4,  1, 'Building REST APIs with Node.js & Express',
      ...
      'https://videos.mini-lms.dev/web-dev/lesson-04-nodejs.mp4', 4, NOW());
...
INSERT INTO lessons (id, course_id, title, content, video_url, order_no, created_at) VALUES
  (5,  2, 'Python for Data Analysis with Pandas',
      ...
      'https://videos.mini-lms.dev/data-science/lesson-01-pandas.mp4', 1, NOW()),
  ...
  (6,  2, 'Data Visualisation with Matplotlib & Seaborn',
      ...
      'https://videos.mini-lms.dev/data-science/lesson-02-visualisation.mp4', 2, NOW()),
  ...
  (7,  2, 'Machine Learning with Scikit-learn',
      ...
      'https://videos.mini-lms.dev/data-science/lesson-03-sklearn.mp4', 3, NOW()),
  ...
  (8,  2, 'Neural Networks & Deep Learning with TensorFlow',
      ...
      'https://videos.mini-lms.dev/data-science/lesson-04-tensorflow.mp4', 4, NOW());
...
INSERT INTO lessons (id, course_id, title, content, video_url, order_no, created_at) VALUES
  (9,  3, 'User Research & Personas',
      ...
      'https://videos.mini-lms.dev/uiux/lesson-01-research.mp4', 1, NOW()),
  ...
  (10, 3, 'Wireframing & Prototyping in Figma',
      ...
      'https://videos.mini-lms.dev/uiux/lesson-02-figma.mp4', 2, NOW()),
  ...
  (11, 3, 'Visual Design & Design Systems',
      ...
      'https://videos.mini-lms.dev/uiux/lesson-03-visual-design.mp4', 3, NOW());
...
INSERT INTO lessons (id, course_id, title, content, video_url, order_no, created_at) VALUES
  (12, 4, 'Python Basics: Variables, Types & Control Flow',
      ...
      'https://videos.mini-lms.dev/python/lesson-01-basics.mp4', 1, NOW()),
  ...
  (13, 4, 'Functions, Modules & Packages',
      ...
      'https://videos.mini-lms.dev/python/lesson-02-functions.mp4', 2, NOW()),
  ...
  (14, 4, 'Object-Oriented Programming in Python',
      ...
      'https://videos.mini-lms.dev/python/lesson-03-oop.mp4', 3, NOW()),
  ...
  (15, 4, 'Testing with pytest & Code Quality',
      ...
      'https://videos.mini-lms.dev/python/lesson-04-testing.mp4', 4, NOW());
...
INSERT INTO lessons (id, course_id, title, content, video_url, order_no, created_at) VALUES
  (16, 5, 'SEO: From Fundamentals to Technical Mastery',
      ...
      'https://videos.mini-lms.dev/marketing/lesson-01-seo.mp4', 1, NOW()),
  ...
  (17, 5, 'Paid Advertising: Google Ads & Meta Campaigns',
      ...
      'https://videos.mini-lms.dev/marketing/lesson-02-paid-ads.mp4', 2, NOW()),
  ...
  (18, 5, 'Analytics & Conversion Rate Optimisation',
      ...
      'https://videos.mini-lms.dev/marketing/lesson-03-analytics.mp4', 3, NOW());
...
INSERT INTO enrollments (id, student_id, course_id, enrolled_at) VALUES
  -- Sarah Johnson
  (1,  2, 1, NOW()),   -- Web Dev
  (2,  2, 2, NOW()),   -- Data Science
  (3,  2, 4, NOW()),   -- Python Bootcamp

  -- Michael Chen
  (4,  3, 1, NOW()),   -- Web Dev
  (5,  3, 3, NOW()),   -- UI/UX Design

  -- Priya Sharma
  (6,  4, 2, NOW()),   -- Data Science
  (7,  4, 3, NOW()),   -- UI/UX Design
  (8,  4, 5, NOW()),   -- Digital Marketing

  -- Luca Rossi
  (9,  5, 4, NOW()),   -- Python Bootcamp
  (10, 5, 5, NOW()),   -- Digital Marketing

  -- Amara Okafor
  (11, 6, 1, NOW()),   -- Web Dev
  (12, 6, 4, NOW());   -- Python Bootcamp

-- =============================================================================
-- 6. assignments
-- =============================================================================
INSERT INTO assignments (id, course_id, title, description, deadline, max_marks, created_at) VALUES
  -- Web Dev assignments
  ...
  (8, 5, 'Digital Marketing Audit & Strategy Document',
      ...
      '2026-07-30 23:59:00', 100, NOW());

-- =============================================================================
-- 7. submissions
-- =============================================================================
INSERT INTO submissions (id, assignment_id, student_id, submission_file, status, submitted_at) VALUES
  -- Sarah Johnson (student_id=2) — enrolled in Web Dev, Data Science, Python Bootcamp
  (1, 1, 2, 'https://storage.mini-lms.dev/submissions/sarah-johnson/portfolio-website.zip',       'Reviewed', NOW()),
  (3, 3, 2, 'https://storage.mini-lms.dev/submissions/sarah-johnson/eda-report.ipynb',            'Submitted', NOW()),
  (5, 6, 2, 'https://storage.mini-lms.dev/submissions/sarah-johnson/cli-task-manager.zip',        'Submitted', NOW()),

  -- Michael Chen (student_id=3) — enrolled in Web Dev, UI/UX Design
  (2, 1, 3, 'https://storage.mini-lms.dev/submissions/michael-chen/portfolio-website.zip',        'Reviewed', NOW()),
  (6, 5, 3, 'https://storage.mini-lms.dev/submissions/michael-chen/healthtrack-prototype.fig',    'Submitted', NOW()),

  -- Priya Sharma (student_id=4) — enrolled in Data Science, UI/UX Design, Digital Marketing
  (4, 3, 4, 'https://storage.mini-lms.dev/submissions/priya-sharma/eda-kaggle-dataset.ipynb',     'Reviewed', NOW()),
  (7, 5, 4, 'https://storage.mini-lms.dev/submissions/priya-sharma/healthtrack-prototype.fig',    'Reviewed', NOW()),
  (8, 8, 4, 'https://storage.mini-lms.dev/submissions/priya-sharma/marketing-audit.pdf',          'Submitted', NOW()),

  -- Luca Rossi (student_id=5) — enrolled in Python Bootcamp, Digital Marketing
  (9,  6, 5, 'https://storage.mini-lms.dev/submissions/luca-rossi/cli-task-manager.zip',         'Rejected', NOW()),
  (10, 8, 5, 'https://storage.mini-lms.dev/submissions/luca-rossi/marketing-strategy.pdf',       'Submitted', NOW()),

  -- Amara Okafor (student_id=6) — enrolled in Web Dev, Python Bootcamp
  (11, 1, 6, 'https://storage.mini-lms.dev/submissions/amara-okafor/portfolio-website.zip',      'Submitted', NOW()),
  (12, 6, 6, 'https://storage.mini-lms.dev/submissions/amara-okafor/cli-task-manager.zip',       'Submitted', NOW());

-- =============================================================================
-- 8. progress
-- =============================================================================
INSERT INTO progress (id, student_id, course_id, percentage, last_updated) VALUES
  -- Sarah Johnson
  (1,  2, 1, 75.00, NOW()),   -- Web Dev — 3 of 4 lessons done
  (2,  2, 2, 50.00, NOW()),   -- Data Science — halfway through
  (3,  2, 4, 25.00, NOW()),   -- Python Bootcamp — just started

  -- Michael Chen
  (4,  3, 1, 100.00, NOW()),  -- Web Dev — fully completed
  (5,  3, 3, 33.33, NOW()),   -- UI/UX — 1 of 3 lessons done

  -- Priya Sharma
  (6,  4, 2, 75.00, NOW()),   -- Data Science — 3 of 4 lessons done
  (7,  4, 3, 66.67, NOW()),   -- UI/UX — 2 of 3 lessons done
  (8,  4, 5, 33.33, NOW()),   -- Digital Marketing — 1 of 3 lessons done

  -- Luca Rossi
  (9,  5, 4, 50.00, NOW()),   -- Python Bootcamp — halfway
  (10, 5, 5, 66.67, NOW()),   -- Digital Marketing — 2 of 3 lessons done

  -- Amara Okafor
  (11, 6, 1, 50.00, NOW()),   -- Web Dev — halfway
  (12, 6, 4, 75.00, NOW());   -- Python Bootcamp — 3 of 4 lessons done
